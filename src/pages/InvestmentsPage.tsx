        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Acompanhe metas, aportes e simulador em um só lugar</p>
                </div>
            </div>

            <Tabs defaultValue="overview">
                <TabsList className="w-full sm:w-auto flex-wrap sm:flex-nowrap gap-2">
                    <TabsTrigger value="overview">Visão Geral</TabsTrigger>
                    <TabsTrigger value="goals">Metas</TabsTrigger>
                    <TabsTrigger value="statement">Extrato Mensal</TabsTrigger>
                    ...
                    <div className="space-y-4">
                        <div className="grid gap-4 md:grid-cols-3">
                                ...
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-sm font-medium text-muted-foreground">Meta Acumulada</CardTitle>
                            ...
                            <Card className="rounded-xl border-border/50 bg-card shadow-sm">
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    <CardTitle className="text-sm font-medium text-muted-foreground">Acumulado Realizado</CardTitle>
                            ...
                            <Card className="rounded-xl border-border/50 bg-card shadow-sm">
                                ...
                                <CardContent>
                                    <div className={`text-2xl font-bold ${performance >= 100 ? "text-emerald-500" : "text-amber-500"}`}>
